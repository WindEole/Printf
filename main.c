...
/*   Updated: 2021/03/06 15:03:02 by iderighe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	printf("\n[%%s] de Aie\n\n");
	...
	t[0] = printf("printf    : [%u]", u);
	printf(" --- add = [%d]\n", t[0]);
	t[1] = ft_printf("ft_printf : [%u]", u);
	printf(" --- add = [%d]\n\n", t[1]);

	printf("\n[%%0*.10u] de %u, 20\n\n", u);

	t[4] = printf("printf    : [%0*.10u]", 20, u);
	printf(" --- add = [%d]\n", t[4]);
	t[5] = ft_printf("ft_printf : [%0*.10u]", 20, u);
	printf(" --- add = [%d]\n\n", t[5]);

	printf("\n[%%010u] de %u\n\n", u);

	t[6] = printf("printf    : [%10u]", u);
	printf(" --- add = [%d]\n", t[6]);
	t[7] = ft_printf("ft_printf : [%010u]", u);
	printf(" --- add = [%d]\n\n", t[7]);

	printf("\n[%%0*u] de %u, 7\n\n", u);

	t[8] = printf("printf    : [%0*u]", 7, u);
	printf(" --- add = [%d]\n", t[8]);
	t[9] = ft_printf("ft_printf : [%0*u]", 7, u);
	printf(" --- add = [%d]\n\n", t[9]);
	...
	t[14] = printf("printf    : [%-5.10u]", u);
	printf(" --- add = [%d]\n", t[14]);
	t[15] = ft_printf("ft_printf : [%-5.10u]", u);
	printf(" --- add = [%d]\n\n", t[15]);

	printf("\n[%%-1.5u] de %u\n\n", u);

	t[16] = printf("printf    : [%-1.5u]", u);
	printf(" --- add = [%d]\n", t[16]);
	t[17] = ft_printf("ft_printf : [%-1.5u]", u);
	printf(" --- add = [%d]\n\n", t[17]);

	printf("\n[%%-1.1] de %u\n\n", u);

	t[18] = printf("printf    : [%-1.1u]", u);
	printf(" --- add = [%d]\n", t[18]);
	t[19] = ft_printf("ft_printf : [%-1.1u]", u);
	printf(" --- add = [%d]\n\n", t[19]);
